...
const Ucuncu = () => {
  return (
    <div>
      ...
      <Col >
      <img style={{height:'500px', borderRadius:'50%'}} src="./img/IMG-20220917-WA0013.jpg" alt="" />
      </Col>

        
      <Col >
        <h1 style={{fontFamily:'Cursive', marginTop:'100px'}}>Tarihi Ve Turistik Yerleri Gezmeyi Coook Severim..</h1>

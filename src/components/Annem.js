...
const Annem = () => {
  return (
    <div id='family' style={{marginTop:'3rem'}}>
          <Row>
...
<Col  >
  <h1 style={{fontFamily:'Cursive', marginTop:'100px'}}>Iste Canim Annem..</h1>
...
<Col >
<img style={{height:'500px', borderRadius:'50%'}} src="./img/IMG-20220916-WA0000.jpg" alt="" />
</Col>
